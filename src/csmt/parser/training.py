...
from csmt.parser.base import boolean_string, add_misc_options, \
...
def add_training_options(parser):
    ...
    group.add_argument("--epoch_num", type=int, help="number of epochs of training", default=3001)
    group.add_argument("--save_iter", type=int, default=200, help="frequency of saving model/viz per xx epoch")
    group.add_argument("--print_iter", type=int, default=10, help="frequency of printing training status")
    ...
    group.add_argument('--num_workers', type=int, default=4,
                       help='DataLoader worker count for teacher training.')
