...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--input-pkl", type=str, required=True, help="Input source-topology motion PKL")
    p.add_argument("--output-pkl", type=str, required=True, help="Output target-topology motion PKL")
...
def main() -> None:
    ...
    motion_pkl = _load_motion_pkl(args.input_pkl)
    ...
    _save_motion_pkl(args.output_pkl, out_pkl)
    ...
    print(f"  input:  {Path(args.input_pkl).resolve()}")
